...
export const INITIAL_BALL_SPEED = 4.5;
export const MAX_BALL_SPEED = 9;
...
export const BRICK_OFFSET_X = (CANVAS_WIDTH - (BRICK_COLS * (BRICK_WIDTH + BRICK_PADDING) - BRICK_PADDING)) / 2;
